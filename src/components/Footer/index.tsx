        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5 text-white">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a className="ease-out duration-200 hover:text-white" href="#">
                  Privacy Policy
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-1 font-medium text-white lg:text-right">
              Download App
            </h2>

            <p className="lg:text-right text-custom-sm mb-4 text-white">
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-white font-medium">
              &copy; {year}. All rights reserved by Noble Mungu.
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <p className="font-medium text-white">We Accept:</p>
